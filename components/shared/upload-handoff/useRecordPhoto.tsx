    ...
    async (file: File | null) => {
      ...
      try {
        ...
        toast.error("Échec de l'envoi", {
          description: cause instanceof Error ? cause.message : "Envoi impossible",
        })
      } finally {
        setBusy(false)
      }
...
export function RecordPhotoSurfaces({ photo }: { photo: RecordPhoto }) {
  const { inputRef, appliquer, targetKind, subjectId, dialogueOuvert, setDialogueOuvert, onSaved } =
    photo._interne
