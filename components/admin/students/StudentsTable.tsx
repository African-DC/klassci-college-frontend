...
export function StudentsTable() {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Badge variant="outline" className="text-xs">
          {row.original.gender === "M" ? "Masculin" : row.original.gender === "F" ? "Feminin" : "—"}
        </Badge>
      ),
    },
    {
  ...
  if (isError) {
    return <DataError message={error?.message ?? "Impossible de charger les eleves"} onRetry={refetch} />
  }
      ...
      <Dialog open={deleteId !== null} onOpenChange={() => setDeleteId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Cette action est irreversible. L&apos;eleve sera definitivement supprime.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
